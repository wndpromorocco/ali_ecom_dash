    ...
    <>
      ...
      >
        <CardContent className="p-0">
          <div className="relative w-full aspect-square overflow-hidden bg-[#F4F4F5] border-b border-gray-100 flex items-center justify-center group rounded-t-lg">
            ...
            <div className="absolute top-3 left-3 z-20">
              <span className="bg-[#2563EB] text-[#1E3A8A] px-3 py-1 rounded-none text-[9px] sm:text-[10px] md:text-[11px] font-black tracking-wider uppercase shadow-lg">
                LIVRAISON GRATUITE
              </span>
            </div>
          </div>
        ...
        <div className="px-3 md:px-4 pt-3 pb-3 flex-grow flex flex-col">
          {product.type && (
            <div className="text-[9px] sm:text-[10px] md:text-[11px] font-black uppercase tracking-widest text-[#1E3A8A]/60 mb-1">
              {product.type}
            </div>
          )}
          ...
          <div className="mt-auto">
            <div className="flex items-baseline gap-2 sm:gap-3 mb-3">
              <span className="text-[14px] sm:text-[16px] md:text-[18px] font-black text-[#1E3A8A]">
            ...
            <div className="flex items-center gap-1.5 sm:gap-2 w-full flex-nowrap">
              <Button
                ...
                className="flex-grow flex items-center justify-center gap-1 sm:gap-2 px-1.5 sm:px-3 h-10 sm:h-12 md:h-14 rounded-md sm:rounded-lg bg-[#1E3A8A] hover:bg-[#2563EB] text-white transition-all active:scale-95 shadow-md border-none text-[9px] sm:text-[11px] md:text-[12px] font-black uppercase tracking-widest overflow-hidden whitespace-nowrap min-w-0"
              >
              ...
              <button
                ...
                className="flex-none shrink-0 w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 flex items-center justify-center bg-[#2563EB] text-white rounded-md sm:rounded-lg hover:bg-[#c45a11] transition-all active:scale-95 shadow-md"
