      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-10 pb-12 items-start text-center md:text-left">
            ...
            <div className="flex gap-4">
              {socials.map(({ Icon, href, label }) => (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-[#2563EB] hover:bg-[#2563EB] hover:text-white transition-all duration-300 transform hover:scale-110"
                  aria-label={label}
                >
                  <Icon />
                </a>
          ...
          <div className="flex flex-col items-center md:items-start space-y-6">
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/boutique" className="text-gray-400 hover:text-[#2563EB] transition-colors text-[13px] font-medium">Boutique</Link>
              </li>
              <li>
                <Link to="/contact" className="text-gray-400 hover:text-[#2563EB] transition-colors text-[13px] font-medium">Contact</Link>
              </li>
              <li>
                <Link to="/panier" className="text-gray-400 hover:text-[#2563EB] transition-colors text-[13px] font-medium">Mon Panier</Link>
              </li>
            </ul>
          </div>
          ...
          <div className="flex flex-col items-center md:items-start space-y-6 text-center md:text-left">
            ...
            <ul className="space-y-5 flex flex-col items-center md:items-start w-full">
              <li className="flex gap-4 items-center">
                <div className="w-8 h-8 bg-[#2563EB]/10 text-[#2563EB] rounded-full flex items-center justify-center flex-shrink-0">
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    <path d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
                <a href="tel:+212665448023" className="text-gray-400 hover:text-[#2563EB] transition-colors text-[13px] font-medium">
                  +212 665 44 80 23
                </a>
              </li>
              <li className="flex gap-4 items-center">
              ...
              <li className="flex gap-4 items-start">
                <div className="w-8 h-8 bg-[#2563EB]/10 text-[#2563EB] rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                ...
                <div className="text-center md:text-left">
                  <a
                    ...
                    className="text-gray-400 hover:text-[#2563EB] text-[13px] font-medium leading-tight transition-colors"
                  >
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col items-center">
          <p className="text-gray-600 text-[11px] font-medium tracking-wide text-center uppercase">
            © {new Date().getFullYear()} Fadel trading — Développé par <span className="text-[#2563EB] font-black">WND</span>
          </p>
        </div>
