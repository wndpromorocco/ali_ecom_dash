        ...
        >
            <div>
                <h1 className="text-4xl font-black uppercase tracking-tighter text-gray-900 leading-none">
                    PARAMÈTRES <span className="text-[#2563EB]">GÉNÉRAUX</span>
                </h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <div className="lg:col-span-5 space-y-8">
                    <Tabs value={activeTab} onValueChange={(val) => setSearchParams({ tab: val })} className="w-full">
                        <TabsList className="bg-white border border-gray-100 p-1 h-12 rounded-sm w-full shadow-sm">
                            <TabsTrigger
                                value="whatsapp"
                                className="flex-1 rounded-sm h-full data-[state=active]:bg-[#2563EB] data-[state=active]:text-white data-[state=active]:shadow-md data-[state=active]:shadow-[#2563EB30] border border-transparent data-[state=inactive]:border-gray-100 data-[state=inactive]:text-gray-500 font-black uppercase text-[10px] tracking-widest gap-2 transition-all duration-200"
                            >
                        ...
                        <div className="mt-8">
                            <TabsContent value="whatsapp" className="focus-visible:outline-none m-0">
                                <Card className="rounded-sm border-gray-100 shadow-xl bg-white overflow-hidden">
                                    <CardHeader className="bg-gray-50 border-b border-gray-100 p-6 border-l-4 border-l-[#2563EB]">
                                        ...
                                        <form onSubmit={handleSaveWhatsapp} className="space-y-6">
                                            <div className="space-y-1.5">
                                                ...
                                                <Input
                                                    ...
                                                    className="w-full border border-gray-200 rounded-sm px-3 py-2.5 text-[14px] text-gray-700 bg-white focus:border-[#3B82F6] focus:ring-2 focus:ring-blue-100 transition-all h-12 font-bold"
                                            ...
                                            <Button
                                                type="submit"
                                                disabled={isSaving}
                                                className="w-full bg-[#2563EB] hover:bg-[#1D4ED8] text-white rounded-sm font-black uppercase tracking-[0.2em] text-[10px] h-12 shadow-lg shadow-blue-100 transition-all active:scale-[0.98]"
                                            >
                                        ...
                                        <form onSubmit={handleSavePassword} className="space-y-6">
                                            <div className="space-y-2">
                                                ...
                                                <div className="relative">
                                                    <Input
                                                        ...
                                                        className="w-full border border-gray-200 rounded-sm px-3 py-2.5 text-[12px] text-gray-700 bg-white focus:border-[#3B82F6] focus:ring-2 focus:ring-blue-100 transition-all h-12 pr-10 font-bold"
                                                        required
                                                    />
                                                    <button
                                                        type="button"
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <Input
                                                    ...
                                                    className="w-full border border-gray-200 rounded-sm px-3 py-2.5 text-[12px] text-gray-700 bg-white focus:border-[#3B82F6] focus:ring-2 focus:ring-blue-100 transition-all h-12 font-bold"
                                                    required
                                                />
                                            </div>
                                            ...
                                            <Button
                                                type="submit"
                                                disabled={isSaving}
                                                className="w-full bg-[#2563EB] hover:bg-[#1D4ED8] text-white text-[11px] font-black uppercase tracking-[0.15em] px-6 py-3 rounded-sm transition-all shadow-md shadow-blue-100 active:scale-[0.98]"
                                            >
                ...
                <div className="lg:col-span-7 hidden lg:block animate-in slide-in-from-right-10 duration-700 delay-150">
                    <div className="relative group">
                        <div className="absolute -inset-0.5 bg-gradient-to-r from-[#2563EB] to-blue-300 rounded-sm blur opacity-5 group-hover:opacity-10 transition duration-500"></div>
                        <div className="relative bg-[#161c2b] rounded-sm p-10 border border-white/5 shadow-2xl min-h-[500px] flex flex-col justify-between overflow-hidden">
                            ...
                            <div className="absolute top-0 right-0 w-64 h-64 bg-[#2563EB]/5 rounded-full -translate-y-1/2 translate-x-1/2 blur-3xl"></div>

                            {activeTab === 'whatsapp' ? (
                                <>
                                    <div className="relative z-10">
                                        <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#2563EB] rounded-sm mb-6">
                                        ...
                                        <h2 className="text-3xl font-black text-white uppercase tracking-tight mb-4 leading-none">
                                            Canal de Support <span className="text-[#2563EB]">Direct</span>
                                        </h2>
                                        ...
                                        <div className="space-y-5 mb-10">
                                            {[
                                                ...
                                                <div key={idx} className="flex items-center gap-4 group/item">
                                                    <div className="w-10 h-10 rounded-sm bg-white/5 border border-white/10 flex items-center justify-center group-hover/item:border-[#2563EB]/50 transition-all">
                                    ...
                                    <div className="mt-auto pt-10 border-t border-white/5 flex items-end justify-end">
                                        <div className="bg-[#25d366] p-4 rounded-2xl rounded-br-none max-w-[240px] shadow-lg relative transform -rotate-1 hover:rotate-0 transition-transform cursor-default">
                                            ...
                                            <div className="absolute -bottom-2 -left-2 w-10 h-10 bg-[#2563EB]/10 rounded-full blur-xl animate-pulse"></div>
                                        </div>
                                    </div>
                                </>
                            ) : (
                                <>
                                    <div className="relative z-10">
                                        ...
                                        <h2 className="text-3xl font-black text-white uppercase tracking-tight mb-4 leading-none">
                                            Bonnes Pratiques <span className="text-[#2563EB]">Sécurité</span>
                                        </h2>
                                        <p className="text-gray-400 text-sm leading-relaxed mb-10 max-w-md">
                                    ...
                                    <div className="mt-auto pt-6 border-t border-white/5 flex justify-between items-center">
                                        ...
                                        <div className="w-20 h-1 bg-[#2563EB] rounded-full opacity-30 shadow-2xl shadow-[#2563EB]"></div>
                                    </div>
                                </>
                            )}
                        </div>
